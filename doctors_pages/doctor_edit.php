...
<h3 class="text-center py-3" style="color:turquoise">Edit My Account</h3>
<div class="container">
  <form class="docsettings" action="index.html" method="post">
    <label>your old Password : </label><br>
    <input type="password" name="oldpassword" value="" placeholder="old password"><br><br>
    <label>your address : </label><br>
    <input type="text" name="docaddress" value="" placeholder="your address"><br><br>
    <label>your phone : </label><br>
    <input type="text" name="docphone" value="" placeholder="your phone"><br><br>
    <label>your img : </label><br>
    <input type="file" name="docimg" value="" placeholder="docimg"><br><br>
