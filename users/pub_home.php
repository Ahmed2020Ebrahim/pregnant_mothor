...
<!--about section-->
      ...
      <div class="cord">
        ...
        <div class="collapse show" id="linked1">
          <p class="insidecord">This site provides you with many ways<br>to communicate with specialist medical
            ...
            outside your city.<br><a href="user_page.php?inc=doctors">see more...</a></p>
        </div>
        <hr class="m-0">
        ...
        <div class="collapse " id="linked3">
          <p class="insidecord">The site provides you with many useful videos that <br>contain valuable information, and
            ...
            videos instead of reading it contains the same information.<br><a href="user_page.php?inc=videos">see more...</a></p>
        </div>
        <hr class="m-0">
        ...
        <div class="collapse " id="linked4">
          <p class="insidecord">The site contains the most common questions<br> during pregnancy and contains their
            answers.<br><a href="user_page.php?inc=frq">see more...</a></p>
        </div>
        <hr class="m-0">
      </div>
    </div>
  ...
  <section class="doctor">
    <div class="doc-title-animat animated title1">
      <h3>OUR DOCTORS</h3>
    ...
    <div class="hello animated alert alert-pink">
      ...
      <p>You can communicate with any of these doctors through the contact information given under eche image ...<br>You
        ...
        website
        <a href="user_page.php?inc=doctors">from here...</a></p>
    </div><br><br>
      ...
      <div class="allweeks animated">
        <div class="row">
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month2</a></h3>
          </div>
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month3</a></h3>
          </div>
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month4</a></h3>
          </div>
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month5</a></h3>
          </div>
        </div>
        <div class="row">
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month6</a></h3>
          </div>
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month7</a></h3>
          </div>
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month8</a></h3>
          </div>
          <div class="allcols col-lg-3 col-md-6">
            <h3><a href="user_page.php?inc=mid_info">month9</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="videosec">
    ...
    <div class="videocont">
      <iframe class="vid" width="700" height="400" src="https://www.youtube.com/embed/BIbFyKmtpCQ" frameborder="0"
  ...
  <div class="videoscont">
    <div class="container">
      <br><br><br>
      <div class="videotitle animated">
        <h3>Videos</h3>
        <p>Instead of reading,watch videos</p>
      </div>
      <br><br><br>
      <div class=" row">
        <div class="vidinfo animated col-md-6 col-sm-12">
          <h3>instead of reading</h3>
          ...
          <a href="user_page.php?inc=videos">see all videos..</a>
        </div>
    ...
    <div class="frequstcont container">
      <div class="row fr">
        <div class="mulcol animated col-xl-6 col-lg-6 col-md-12 col-12">
          <div>
            <h3>Question?</h3>
            <p>This website is mede just for helping you in pregrancy months , that does not mean you can deppend only
              on
              the information in the.</p>
          </div>
          <div>
            <h3>Question?</h3>
            <p>This website is mede just for helping you in pregrancy months , that does not mean you can deppend only
      ...
      <div class="allqlink"><a href="user_page.php?inc=frq" >See All FrqQuestions..</a></div>
    </div>
  </div><br><br><br>
