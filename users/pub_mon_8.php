...
<!--content-->
    ...
    <div class="weekinfo bg-light p-5" id="Foods">
        <div class="container">
            ...
            <h3>What Foods Should You Include In Your 8 Month Pregnancy Diet?</h3>
            <p>During the third trimester of your pregnancy, you gain the maximum amount of weight and your body gets heavier. This is exactly why you should eat a healthy diet and combine it with a light exercise, such as walking. Here are some foods that you can include in your 8th month of pregnancy diet.</p>
            <strong>1. Foods Rich In Vitamins And Minerals:</strong>
            <p>During the last months of your pregnancy, it is important for you to eat foods that are rich in iron and calcium. Blood loss is a part of delivery and you need to make sure that you include enough iron in your diet. Calcium will keep your and baby’s bones strong so include that too.You should have:</p>
            <ul>
            ...
            <strong>2. Foods Rich In Carbohydrates, Proteins And Fats:</strong>
            <p>Put a chart of “Do not eat” on your fridge. That way it will be easier for your to know what you require to eat at which time of the day.</p>
            <strong>For Protein:</strong>
            <ul>
                <li>Beans</li>
                <li>Lean meat</li>
                <li>Egg whites</li>
            ...
            <strong>For Carbohydrates:</strong>
            <ul>
                <li>Potatoes</li>
                <li>Whole grains</li>
                <li>Cereals</li>
            ...
            <strong>3. Foods Rich In Fiber:</strong>
            <p>High-fiber foods are important during this stage of your pregnancy. These foods have a high nutritive value. They also contain the right amount of fibre that you need in the last months of your pregnancy. You should have:</p>
            <ul>
                <li>Corn</li>
                <li>White beans</li>
                <li>Black beans</li>
    ...
    <div class="weekinfo bg-light p-5" id="Sports">
        <div class="container">
            ...
            <h3>Benefits of doing sport and exercise</h3>
            <p>If you are healthy and have an uncomplicated pregnancy, playing sport can help you stay fitter and stronger, prevent excess weight gain and make you feel better mentally. It may also allow you to have a shorter birth and fewer complications.
            ...
            <h3>Why do I need to be more careful?</h3>
            <p>Although physical activity in pregnancy is safe and good for you, some sports may cause harm to you or your baby. Even in sports that are not risky you may need to make some changes. It’s important to tell your maternity team about any sport you are playing so they can support you.</p><br>
            <h3>Medical conditions that may affect you playing sport</h3>
            <p>Your maternity team may want to monitor your sport or advise you against participating, if you:</p>
            <ul>
                <li>have problems with your heart, lungs or liver</li>
                <li>have diabetes that is not well controlled</li>
                <li>have bone or joint problems</li>
                <li>have an infectious disease</li>
                <li>are obese or underweight</li>
                <li>have problems with your pregnancy or a previous pregnancy</li>
                <li>have anaemia</li>
                <li>are having a multiple birth (e.g. twins or triplets)</li>
            </ul>
            <p>When you are exercising, you should stop and see your doctor straight away, if:</p>
            <ul>
                <li>you have chest pain</li>
                <li>your heart rate is higher than usual</li>
                <li>you have unusual shortness of breath</li>
                <li>your baby’s movements have decreased</li>
                <li>you are having contractions</li>
                <li>you leak or gush fluid from your vagina</li>
                <li>your ankles, hands or face suddenly swell</li>
                <li>you have pain, swelling or redness in your calves</li>
                <li>you have muscle weakness</li>
                <li>you feel dizzy or faint</li>
            </ul>
            <h3>Sport and your level of fitness</h3>
            <p>If you are not currently active and starting a sport, it’s good to choose one which needs less effort. You could start with 15 minutes per session, building up to 30 minutes of moderate intensity. If you’ve been inactive, it’s also a good idea consult your doctor before starting to play a sport during pregnancy.
            ...
            <h3>Sports to avoid</h3>
            <p>You should not play sports that:</p>
            <ul>
                <li>make you work very hard or become too hot</li>
                <li>could cause you to fall</li>
                <li>could hit your baby</li>
                <li>have lots of jumping or bouncing</li>
                <li>involve sudden changes in direction</li>
                <li>involve diving or high altitudes</li>
            </ul>
            <h3>Sport and stages of pregnancy</h3>
            <p>You may need to make some changes as your pregnancy advances.</p>
            <h3>First trimester (1-12 weeks)</h3>
            <p>During this time, try not to overheat so as to protect both yourself and your baby:</p>
            <ul>
                <li>Avoid playing sport in high heat or humidity.</li>
                <li>Wear loose, cool clothing.</li>
                <li>Drink plenty of water</li>
            </ul>
            <h3>Second and third trimesters (13-40 weeks)</h3>
            <p>
            ...
            <h3>What sport is recommended?</h3>
            <p>It’s good to do lower-risk activities that:</p>
            <ul>
                <li>are non-contact or limited contact</li>
                <li>support your weight, such as swimming and aquanatal exercise classes — but try to avoid being in water that is warmer than 32 degrees Celsius for very long</li>
                <li>allow you to exercise in a straight line rather than suddenly shifting positions</li>
                <li>have a limited chance of you falling</li>
                <li>allow you to exercise at low or moderate intensity</li>
                <li>are designed specifically for pregnancy</li>
            </ul>
    ...
    <div class="weekinfo bg-light p-5" id="Warnings">
        <div class="container">
            ...
            <h3>What Foods To Avoid During The 8th Month Of Your Pregnancy?</h3>
            <p>During this stage of your pregnancy, there are certain foods that you should avoid to prevent excess weight gain and the discomfort of some of the symptoms that you go through. Eating nutritious foods is always important throughout your pregnancy to benefit you and your child. Here are some of the foods that you should omit from your daily diet during 8th month of pregnancy:</p>
            <br>
            <strong>1. Coffee:</strong>
            <p>As your due date approaches, you will find yourself constipated which can be really uncomfortable. One way to reduce this symptom is to significantly lower your daily intake of this beverage. You should also lower you intake of caffeinated beverages such as aerated soft drinks, etc.</p><br>
            <strong>2. Unpasteurized Milk:</strong>
            <p>You should avoid unpasteurized goat, cow and sheep milk. Goat’s milk is very risky during pregnancy as it comes with a high risk of toxoplasmosis.</p><br>
            <strong>3. Shark, Marlin And Swordfish:</strong>
            <p>These types of fish have high levels of methylmercury which can be detrimental to your unborn baby’s nervous system. If you are going to eat fish, pick the ones that are not too fatty and provide you and your baby the required nutrition.</p><br>
            <strong>4. Soft Cheese:</strong>
            <p>Cheese that have been ripened with mould such as Brie, as well as cheese that has blue veins such as Danish Blue can often contain listeria which is why they should be avoided during pregnancy. If you have a craving for cheese, opt for hard ones like cheddar.</p><br>
            <strong>5. Pate:</strong>
            <p>It is best to avoid pates of all types. They could contain listeria which causes listeriosis. Although listeriosis causes symptoms that are flu-like in mothers, they can be fatal for unborn babies. It can cause still-birth, miscarriage and serious illnesses when a baby is born.</p><br>
            <strong>6. Raw Or Undercooked Eggs:</strong>
            <p>Eggs that have been lightly cooked or raw should be avoided during pregnancy. There is a high risk of them containing salmonella bacteria which is known to cause food poisoning.</p><br>
            <strong>7. Raw Shell Fish:</strong>
            <p>You should avoid raw shell fish as well as raw fish dishes such as sushi during pregnancy. This is due to the high risk of food poisoning that these foods can cause.</p><br>
            <strong>8. Liver And Cured Meats:</strong>
            <p>It is best to avoid liver during this stage of your pregnancy. In fact, experts say that you should avoid liver throughout your pregnancy. Cured meats like salami and ham should also be avoided as they increase the risk of toxoplasmosis and listeriosis.</p><br>
            <strong>9. Alcohol And Tobacco:</strong>
            <p>These should be avoided for reasons well-known to us all. They can cause a lot of damage to your baby and the baby could be born with health complications.
