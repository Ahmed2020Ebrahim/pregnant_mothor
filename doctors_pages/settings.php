...
<div class="container">
  <div class="row no-gutters pt-4">
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 settingimg text-center"><a href="doctor_page.php?inc=edit"><img src="../img/setting4.png" alt="" ></a>
      <p class="text-primary">edit my account</p>
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 settingimg text-center"><a href="doctor_page.php?inc=repassword"><img src="../img/setting1.png" alt="" ></a>
      <p class="text-primary">change my password</p>
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 settingimg text-center"><a href="doctor_page.php?inc=delete"><img src="../img/deleteimg.png" alt="" ></a>
